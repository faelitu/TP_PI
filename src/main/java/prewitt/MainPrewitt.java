...
public class MainPrewitt {
    public static void main(String[] args) throws Exception {
        ...
        while ((st = br.readLine()) != null) {
            ...
            if (count == 1) {
                bw.append("# "+nome+"Prewitt.pgm created by Rafael Machado\n");
            }
        ...
        int[][] img_prewitt = new int[height][width];
        for (int i = 1; i < height + 1; i++) {
            for (int j = 1; j < width + 1; j++) {
                ...
                img_prewitt[i-1][j-1] = (int) round(sqrt(gradX*gradX + gradY*gradY));
                
                bw.append(String.valueOf(img_prewitt[i-1][j-1]) + " ");
            }
            bw.append("\n");
        }
